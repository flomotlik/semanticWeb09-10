...
public class Main {
	...
	private static final String menu = "HotelExpert\n" + "-----------\n" 
		...
		+ "3 Welche Hintergrundinformationen gibt es f�r <VeranstaltungsName>?\n"
		+ "4 Welche direkte und indirekte Freunde hat <GastName>?\n"
		+ "5 Welche sind die 3 besten Kunden f�r <HotelName>?\n"
		+ "6 Welche pers�nliche Interessen hat <GastName>?\n"
